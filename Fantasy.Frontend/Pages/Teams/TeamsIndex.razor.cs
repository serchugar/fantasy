...
public partial class TeamsIndex(TeamsRepository repo)
{
    private IEnumerable<TeamDTO>? Teams { get; set; }
    ...
    private async Task DeleteAsync(TeamDTO team)
    {
        ...
        var responseHttp = await repo.DeleteAsync(team.Id);
    ...
    private async Task LoadAsync()
    {
        ...
        if (response.Code.IsSuccess()) Teams = response.Data;
    }
}